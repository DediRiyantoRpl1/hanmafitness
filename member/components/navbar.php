            ...
            <div class="user-chip" role="button" data-bs-toggle="dropdown">
                <div class="avatar-mini">
                    <?php if (!empty($fotoProfilNav)): ?>
                        <img src="<?= BASE_URL ?>uploads/profil/<?= htmlspecialchars($fotoProfilNav) ?>"
                             alt="Foto Profil"
                ...
                <div>
                    ...
                    <div style="font-size:.7rem;color:#8a8f98;">Member</div>
                </div>
                <i class="bi bi-chevron-down small"></i>
            </div>
            <ul class="dropdown-menu dropdown-menu-end mt-2">
                <li><a class="dropdown-item" href="<?= BASE_URL ?>member/edit_profil.php"><i class="bi bi-person-circle me-2"></i>Edit Profil</a></li>
